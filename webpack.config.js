...
module.exports = {
  ...
  entry: {
    ...
    arithmetic: './src/uoar1/arithmetic/arithmetic_wrapper.js',
    converter: './src/uoar1/converter/converter_wrapper.js',
    error_correction: './src/uoar1/error_correction/error_correction_wrapper.js',
    ieee754: './src/uoar1/ieee754/ieee754_wrapper.js',
  },
  output: {
